...
public class GraphMLExporterTest extends TestCase {
  ...
  public void testUndirectedUnweightedWithWeights() throws Exception {
    String output =
        // @formatter:off
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
            + NL
  ...
  public void testUndirectedWeightedWithWeights() throws Exception {
    String output =
        // @formatter:off
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
            + NL
            ...
            + "<edge id=\"1\" source=\"1\" target=\"2\">"
            + NL
            + "<data key=\"edge_weight_key\">3.0</data>"
            + NL
            + "</edge>"
            + NL
            + "<edge id=\"2\" source=\"3\" target=\"1\"/>"
  ...
  public void testUndirectedWeightedWithCustomNameWeights() throws Exception {
    String output =
        // @formatter:off
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
            + NL
            ...
            + "xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">"
            + NL
            + "<key id=\"edge_weight_key\" for=\"edge\" attr.name=\"value\" attr.type=\"double\">"
            + NL
            + "<default>1.0</default>"
            + NL
            + "</key>"
  ...
  public void testNoRegisterWeightAttribute() throws Exception {
    try {
  ...
  public void testRegisterWeightAttribute() throws Exception {
    try {
      GraphMLExporter<String, DefaultWeightedEdge> exporter =
          new GraphMLExporter<String, DefaultWeightedEdge>();
  ...
  public void testNoAlreadyRegisteredAttributeAsWeightName() throws Exception {
    try {
      GraphMLExporter<String, DefaultWeightedEdge> exporter =
          new GraphMLExporter<String, DefaultWeightedEdge>();
  ...
  public void testUndirectedWeightedWithWeightsAndLabels() throws Exception {
    String output =
        // @formatter:off
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
            + NL
            ...
            + "<node id=\"1\">"
            + NL
            + "<data key=\"vertex_label_key\">v1</data>"
            + NL
            + "</node>"
            + NL
            + "<node id=\"2\">"
            + NL
            + "<data key=\"vertex_label_key\">v2</data>"
            + NL
            + "</node>"
            + NL
            + "<node id=\"3\">"
            + NL
            + "<data key=\"vertex_label_key\">v3</data>"
            + NL
            + "</node>"
            + NL
            + "<edge id=\"1\" source=\"1\" target=\"2\">"
            + NL
            + "<data key=\"edge_label_key\">(v1 : v2)</data>"
            + NL
            + "<data key=\"edge_weight_key\">3.0</data>"
            + NL
            + "</edge>"
            ...
            + "<edge id=\"2\" source=\"3\" target=\"1\">"
            + NL
            + "<data key=\"edge_label_key\">(v3 : v1)</data>"
            + NL
            + "<data key=\"edge_weight_key\">15.0</data>"
            + NL
            + "</edge>"
            + NL
            + "</graph>"
  ...
  public void testUndirectedWeightedWithWeightsAndLabelsAndCustomNames() throws Exception {
    String output =
        // @formatter:off
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
            + NL
            ...
            + "xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">"
            + NL
            + "<key id=\"vertex_label_key\" for=\"node\" attr.name=\"custom_vertex_label\" attr.type=\"string\"/>"
            + NL
            + "<key id=\"edge_label_key\" for=\"edge\" attr.name=\"custom_edge_label\" attr.type=\"string\"/>"
            + NL
            + "<key id=\"edge_weight_key\" for=\"edge\" attr.name=\"weight\" attr.type=\"double\">"
            + NL
            + "<default>1.0</default>"
            ...
            + "<node id=\"1\">"
            + NL
            + "<data key=\"vertex_label_key\">myvertex-v1</data>"
            + NL
            + "</node>"
            + NL
            + "<node id=\"2\">"
            + NL
            + "<data key=\"vertex_label_key\">myvertex-v2</data>"
            + NL
            + "</node>"
            + NL
            + "<node id=\"3\">"
            + NL
            + "<data key=\"vertex_label_key\">myvertex-v3</data>"
            + NL
            + "</node>"
            + NL
            + "<edge id=\"1\" source=\"1\" target=\"2\">"
            + NL
            + "<data key=\"edge_label_key\">myedge-(v1 : v2)</data>"
            + NL
            + "<data key=\"edge_weight_key\">3.0</data>"
            + NL
            + "</edge>"
            ...
            + "<edge id=\"2\" source=\"3\" target=\"1\">"
            + NL
            + "<data key=\"edge_label_key\">myedge-(v3 : v1)</data>"
            + NL
            + "<data key=\"edge_weight_key\">15.0</data>"
            + NL
            + "</edge>"
    ...
    GraphMLExporter<String, DefaultWeightedEdge> exporter = new GraphMLExporter<>();
    exporter.setVertexLabelProvider(
        new ComponentNameProvider<String>() {
          @Override
          public String getName(String vertex) {
  ...
  public void testUndirectedWeightedWithWeightsAndColor() throws Exception {
    String output =
        // @formatter:off
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
            + NL
            ...
            + "</key>"
            + NL
            + "<key id=\"key1\" for=\"all\" attr.name=\"name\" attr.type=\"string\">"
            + NL
            + "<default>johndoe</default>"
            + NL
            + "</key>"
            + NL
            + "<graph edgedefault=\"undirected\">"
            ...
            + "<node id=\"1\">"
            + NL
            + "<data key=\"key1\">V1</data>"
            + NL
            + "</node>"
            + NL
            + "<node id=\"2\">"
            + NL
            + "<data key=\"key0\">red</data>"
            + NL
            + "<data key=\"key1\">V2</data>"
            + NL
            + "</node>"
            + NL
            + "<node id=\"3\">"
            + NL
            + "<data key=\"key1\">V3</data>"
            + NL
            + "</node>"
            + NL
            + "<edge id=\"1\" source=\"1\" target=\"2\">"
            ...
            + "<data key=\"edge_weight_key\">3.0</data>"
            + NL
            + "<data key=\"key1\">e12</data>"
            + NL
            + "</edge>"
            + NL
            + "<edge id=\"2\" source=\"3\" target=\"1\">"
            + NL
            + "<data key=\"key1\">e31</data>"
            + NL
            + "</edge>"
            + NL
            + "</graph>"
  ...
  public void testUndirectedWeightedWithNullComponentProvider() throws Exception {
    String output =
        // @formatter:off
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
            + NL
