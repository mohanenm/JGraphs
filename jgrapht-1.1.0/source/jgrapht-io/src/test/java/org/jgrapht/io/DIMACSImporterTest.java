...
public class DIMACSImporterTest extends TestCase {
  ...
  public <E> Graph<Integer, E> readGraph(
    ...
    DIMACSImporter<Integer, E> importer =
        new DIMACSImporter<>(
  ...
  public void testReadDIMACSInstance() throws ImportException {
  ...
  public void testReadWeightedDIMACSInstance() throws ImportException {
    InputStream fstream = getClass().getClassLoader().getResourceAsStream("myciel3_weighted.col");
    Graph<Integer, DefaultWeightedEdge> graph = readGraph(fstream, DefaultWeightedEdge.class, true);
  ...
  public void testReadDIMACSShortestPathFormat() throws ImportException {
    // @formatter:off
  ...
  public void testWrongDIMACSInstance1() throws ImportException {
    // @formatter:off
  ...
  public void testWrongDIMACSInstance2() throws ImportException {
    // @formatter:off
  ...
  public void testWrongDIMACSInstance3() throws ImportException {
    // @formatter:off
  ...
  public void testWrongDIMACSInstance4() throws ImportException {
    // @formatter:off
