...
public class Graph6Sparse6ImporterTest {
  ...
  public <E> Graph<Integer, E> readGraph(
      InputStream in, Class<? extends E> edgeClass, boolean weighted) throws ImportException {
    Graph<Integer, E> g;
    if (weighted) g = new WeightedPseudograph<>(edgeClass);
    else g = new Pseudograph<>(edgeClass);

    Graph6Sparse6Importer<Integer, E> importer =
        new Graph6Sparse6Importer<>(
  ...
  @Test
  public void testExampleGraph() throws ImportException {
    String input = ":Fa@x^\n";
    ...
    for (int[] edge : edges) assertTrue(graph.containsEdge(edge[0], edge[1]));
  }
  ...
  @Test
  public void testNumberVertices1() throws ImportException {
    String input =
  ...
  @Test
  public void testNumberVertices2() throws ImportException {
    String input =
  ...
  @Test
  public void testGraph6a() throws ImportException {
    // Klein7RegularGraph
  ...
  @Test
  public void testGraph6b() throws ImportException {
  ...
  @Test
  public void testGraph6c() throws ImportException {
    // goldnerHararyGraph
  ...
  @Test
  public void testGraph6d() throws ImportException {
    // buckyBallGraph
    String input =
  ...
  @Test
  public void testGraph6f() throws ImportException {
    // heawoodGraph
  ...
  @Test
  public void testSparse6a() throws ImportException {
    // Klein7RegularGraph
    String input =
  ...
  @Test
  public void testSparse6b() throws ImportException {
    // ellinghamHorton78Graph
    String input =
  ...
  @Test
  public void testSparse6c() throws ImportException {
    // goldnerHararyGraph
  ...
  @Test
  public void testSparse6d() throws ImportException {
    // buckyBallGraph
    String input =
  ...
  @Test
  public void testSparse6f() throws ImportException {
    // heawoodGraph
  ...
  @Test
  public void testSparse6g() throws ImportException {
  ...
  public void testFromFile() throws ImportException, IOException {
    ...
    Graph6Sparse6Importer<Integer, DefaultEdge> importer =
        new Graph6Sparse6Importer<>(
            (l, a) -> Integer.parseInt(l), (f, t, l, a) -> g.getEdgeFactory().createEdge(f, t));
  ...
  private <V, E> void compare(Graph<V, E> orig, Graph<V, E> g) {
    ...
    // The original and output graph cannot be compared 1:1 since sparse6/graph6 encodings do not
    // preserve vertex labels
    // Testing for graph isomorphism is hard, so we compare characteristics.
    int[] degeeVectorOrig = new int[orig.edgeSet().size()];
    for (V v : orig.vertexSet()) degeeVectorOrig[orig.degreeOf(v)]++;

    int[] degeeVectorG = new int[g.edgeSet().size()];
    for (V v : g.vertexSet()) degeeVectorG[g.degreeOf(v)]++;
