...
public class MatrixExporterTest extends TestCase {
  ...
  private static final String LAPLACIAN =
      "1 1 2" + NL + "1 2 -1" + NL + "1 3 -1" + NL + "2 2 1" + NL + "2 1 -1" + NL + "3 3 1" + NL
          + "3 1 -1" + NL;
  ...
  public void testLaplacian() throws ExportException {
  ...
  public void testAdjacencyUndirected() throws ExportException {
  ...
  public void testAdjacencyDirected() throws ExportException {
    Graph<String, DefaultEdge> g = new DirectedMultigraph<String, DefaultEdge>(DefaultEdge.class);
    g.addVertex(V1);
    g.addVertex(V2);
    g.addEdge(V1, V2);
    g.addVertex(V3);
