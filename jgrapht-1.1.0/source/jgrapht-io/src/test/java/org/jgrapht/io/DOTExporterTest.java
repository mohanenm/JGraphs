...
public class DOTExporterTest extends TestCase {
  ...
  private void testUndirectedWithGraphAttributes(Graph<String, DefaultEdge> g, boolean strict)
    ...
    String res = new String(os.toByteArray(), "UTF-8");
    assertEquals(
        (strict) ? "strict " + UNDIRECTED_WITH_GRAPH_ATTRIBUTES : UNDIRECTED_WITH_GRAPH_ATTRIBUTES,
        res);
  }

  public void testValidNodeIDs() throws ExportException {
    DOTExporter<String, DefaultEdge> exporter =
        new DOTExporter<>(
  ...
  public void testDifferentGraphID() throws UnsupportedEncodingException, ExportException {
