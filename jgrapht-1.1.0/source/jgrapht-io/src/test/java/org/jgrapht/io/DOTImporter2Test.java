...
public class DOTImporter2Test {
  ...
  @Test
  public void testDOT1() throws ImportException {
    // @formatter:off
    String input = "digraph {" + NL + "  a -- b -- c;" + NL + "  k:1 -- q:a:3 -- d:3;" + NL + "}";
    // @formatter:on
  ...
  @Test
  public void testDOT2() throws ImportException {
    // @formatter:off
    String input =
        "digraph G {"
            + NL
    ...
    Graphs.addAllVertices(
        expected, Arrays.asList("a0", "a1", "a2", "a3", "b0", "b1", "b2", "b3", "start", "end"));
  ...
  @Test
  public void testDOT3() throws ImportException {
    // @formatter:off
    String input =
        "digraph G {"
            + NL
  ...
  @Test
  public void testDOT4() throws ImportException {
    // @formatter:off
    String input =
        "digraph G {"
            + NL
  ...
  @Test
  public void testNodeSubgraphEdges() throws ImportException {
    // @formatter:off
    String input = "digraph G {" + NL + "  a0 -> { a00 -> a11 } -> b0 -> { b00 -> b11 }" + NL + "}";
    // @formatter:on
  ...
  @Test
  public void testNodeSubgraphEdgesUndirected() throws ImportException {
    // @formatter:off
    String input = "digraph G {" + NL + "  a0 -> { a00 -- a11 } -> b0 -- { b00 -- b11 }" + NL + "}";
    // @formatter:on
  ...
  @Test
  public void testNestedSubgraphs() throws ImportException {
    // @formatter:off
    String input =
        "digraph G {"
            + NL
  ...
  @Test
  public void testEdgeAttributes() throws ImportException {
    // @formatter:off
    String input =
        "digraph G {"
            + NL
  ...
  @Test
  public void testComments() throws ImportException {
    // @formatter:off
    String input =
        "digraph G { // ignore"
            + NL
  ...
  @Test
  public void testNodeAttributes() throws ImportException {
    // @formatter:off
    String input =
        "digraph G {"
            + NL
  ...
  @Test
  public void testUnescape() throws ImportException {
    // @formatter:off
    String input =
        "digraph G {"
            + NL
    ...
    assertEquals(
        "<a href=\"http:///www.jgrapht.org\"/>", vertexAttributes.get("a6").get("name").getValue());
    assertEquals(
  ...
  @Test
  public void testNonValidHtmlString() throws ImportException {
    // @formatter:off
    String input = "digraph G {" + NL + "  a0 [name=< >> >];" + NL + "}";
    // @formatter:on
  ...
  @Test
  public void testValidHtmlString() throws ImportException {
    // @formatter:off
    String input = "digraph G {" + NL + "  a0 [name=<<h1/>>];" + NL + "}";
    // @formatter:on
  ...
  @Test
  public void testError() throws ImportException {
    // @formatter:off
    String input =
        "digraph G {"
            + NL
  ...
  @Test
  public void testLoopError() throws ImportException {
    // @formatter:off
    String input = "digraph G {" + NL + "  a0 -> a0;" + NL + "}";
    // @formatter:on
  ...
  @Test
  public void testExampleDOT1() throws ImportException {
    // @formatter:off
    String input =
        "digraph G {"
            + NL
  ...
  @Test
  public void testShapes1() throws ImportException {
    // @formatter:off
