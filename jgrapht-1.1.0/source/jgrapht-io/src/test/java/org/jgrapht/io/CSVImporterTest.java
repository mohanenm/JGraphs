...
public class CSVImporterTest extends TestCase {
  ...
  public void testEdgeListDirectedUnweightedWithSemicolon() throws ImportException {
    // @formatter:off
    String input = "1;2\n" + "2;3\n" + "3;4\n" + "4;1\n";
    // @formatter:on
  ...
  public void testAdjacencyListDirectedUnweightedWithSemicolon() throws ImportException {
    // @formatter:off
  ...
  public void testDirectedMatrixNoNodeIdZeroNoEdgeWeighted() throws ImportException {
    // @formatter:off
    String input =
        "0;1.0;13.0;0;0"
            + NL
    ...
    CSVImporter<String, DefaultWeightedEdge> importer = createImporter(g, CSVFormat.MATRIX, ';');
  ...
  public void testDirectedMatrixNoNodeIdWeighted() throws ImportException {
    // @formatter:off
    String input =
        ",1.0,13.0,,"
            + NL
  ...
  public void testDirectedMatrixNoNodeIdZeroNoEdge() throws ImportException {
    // @formatter:off
    String input =
        "0;1;1;0;0"
            + NL
  ...
  public void testDirectedMatrixNoNodeId() throws ImportException {
    // @formatter:off
    String input = ";1;1;;" + NL + ";;;;" + NL + "1;;;1;" + NL + ";;;;1" + NL + "1;1;1;1;1" + NL;
    // @formatter:on
  ...
  public void testDirectedMatrixNodeIdZeroNoEdge() throws ImportException {
    // @formatter:off
    String input =
        ";A;B;C;D;E"
            + NL
  ...
  public void testDirectedMatrixNodeIdZeroNoEdgeShuffled() throws ImportException {
    // @formatter:off
    String input =
        ";A;B;C;D;E"
            + NL
  ...
  public void testDoubleOnUnweighted() throws ImportException {
    // @formatter:off
    String input =
        ";A;B;C;D;E"
            + NL
  ...
  public void testWrongHeaderNodeIds() throws ImportException {
    // @formatter:off
    String input =
        ";A;B;  ;D;E"
            + NL
  ...
  public void testDirectedMatrixNoNodeIdMissingEntries() throws ImportException {
    // @formatter:off
    String input = ";1;1;;" + NL + ";;;;" + NL + "1;;;1;" + NL + ";;;1" + NL + "1;1;1;1;1" + NL;
    // @formatter:on
  ...
  public void testDirectedMatrixNodeIdZeroNoEdgeShuffledAndTabDelimiter() throws ImportException {
    // @formatter:off
    String input =
        "\tA\tB\t\"C\tC\"\tD\tE"
            + NL
