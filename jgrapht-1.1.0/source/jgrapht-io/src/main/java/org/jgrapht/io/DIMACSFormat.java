 ...
 *
 * <p>For a general description of the formats see <a href="http://dimacs.rutgers.edu/Challenges/">
...
public enum DIMACSFormat {
   ...
   *
   * <p>This is the <a href="http://www.dis.uniroma1.it/challenge9/format.shtml">format</a> used in
   * the 9th DIMACS implementation challenge.
   *
   * <p>A shortest path graph file looks as follows:
   *
   * <pre>{@code
   * c <comments>
   ...
   *
   * <p>This is the <a href="http://mat.gsia.cmu.edu/COLOR/general/ccformat.ps">format</a> used in
   * the 2nd DIMACS implementation challenge.
   *
   * <p>A graph file looks as follows:
   *
   * <pre>{@code
   * c <comments>
   ...
   * Coloring format.
   *
   * <p>This is the <a href="ftp://dimacs.rutgers.edu/pub/challenge/">format</a> used in the 2nd
