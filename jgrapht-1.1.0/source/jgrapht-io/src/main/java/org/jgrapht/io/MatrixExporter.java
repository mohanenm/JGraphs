 ...
 * software, such as <a href="http://rs.cipr.uib.no/mtj/">MTJ</a> or <a
 * href="http://www.mathworks.com/products/matlab/">MATLAB</a>.
 *
 * <p>The exporter supports three different formats, see {@link Format}.
 *
 * @see Format
 ...
 */
public class MatrixExporter<V, E> extends AbstractBaseExporter<V, E>
  ...
  public enum Format {
    /**
     * A sparse representation of the adjacency matrix. This is the default. Exports the specified
     * graph into a plain text file format containing a sparse representation of the graph's
     * adjacency matrix. The value stored in each position of the matrix indicates the number of
     * edges between two vertices. With an undirected graph, the adjacency matrix is symmetric.
     */
  ...
  /**
   * Creates a new MatrixExporter with integer name provider for the vertex identifiers and {@link
   * Format#SPARSE_ADJACENCY_MATRIX} as the default format.
   */
