 ...
 */
public class GraphMLExporter<V, E> extends AbstractBaseExporter<V, E>
   ...
   * @param edgeLabelProvider for generating edge labels. If null, edge labels will not be exported.
   */
  public GraphMLExporter(
   ...
   * @param edgeIDProvider for generating edge identifiers. Must not be null.
   * @param edgeLabelProvider for generating edge labels. If null, edge labels will not be exported.
   * @param edgeAttributeProvider for generating edge attributes. If null, no additional attributes
   *     will be exported.
   */
  public GraphMLExporter(
      ComponentNameProvider<V> vertexIDProvider,
  ...
  private void writeEdges(TransformerHandler handler, Graph<V, E> g) throws SAXException {
    ...
    for (E e : g.edgeSet()) {
      ...
      attr.addAttribute("", "", "source", "CDATA", vertexIDProvider.getName(g.getEdgeSource(e)));
      attr.addAttribute("", "", "target", "CDATA", vertexIDProvider.getName(g.getEdgeTarget(e)));
