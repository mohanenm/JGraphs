 ...
 *
 * <p>For a description of the format see <a href="http://dimacs.rutgers.edu/Challenges/">
 ...
 * @since January 2017
 */
public class DIMACSExporter<V, E> extends AbstractBaseExporter<V, E>
  ...
  public void exportGraph(Graph<V, E> g, Writer writer) {
    ...
    out.println("c");
    out.println("p " + format.getProblem() + " " + g.vertexSet().size() + " " + g.edgeSet().size());
