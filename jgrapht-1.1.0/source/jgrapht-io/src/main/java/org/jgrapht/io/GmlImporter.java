 ...
 * href="http://www.infosun.fmi.uni-passau.de/Graphlet/GML/">http://www.
 ...
 * </pre>
 *
 * <p>In case the graph is weighted then the importer also reads edge weights. Otherwise edge
 * weights are ignored. The importer also supports reading additional string attributes such as
 * label or custom user attributes. String attributes are unescaped as if they are Java strings.
 *
 * @param <V> the vertex type
 * @param <E> the edge type
 * @author Dimitrios Michail
 */
public class GmlImporter<V, E> extends AbstractBaseImporter<V, E> implements GraphImporter<V, E> {
  /**
