 ...
 *
 * <p>This adapter will not convert JGraphX to JGraphT - this should be handled in another class
 * entirely.
 *
 * <p>Known Bugs: If this class is used with String-Edges, please note that there is a bug with the
...
public class JGraphXAdapter<V, E> extends mxGraph implements GraphListener<V, E> {
  ...
  /**
   * Constructs and draws a new mxGraph from a jGraphT graph. Changes on the jgraphT graph will not
   * edit this mxGraph any further; use the constructor with the ListenableGraph parameter instead
   * or use this graph as a normal mxGraph. Throws an IllegalArgumentException if the parameter is
   * null.
   *
