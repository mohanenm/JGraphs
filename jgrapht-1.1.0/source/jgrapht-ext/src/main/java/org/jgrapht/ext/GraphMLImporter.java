 ...
 * an instance of {@link org.jgrapht.WeightedGraph} and the corresponding edge key with
 ...
 *
 * <p>The importer validates the input using the 1.0 <a
 * href="http://graphml.graphdrawing.org/xmlns/1.0/graphml.xsd">GraphML Schema</a>.
 *
 ...
 */
@Deprecated
public class GraphMLImporter<V, E> implements GraphImporter<V, E> {
  ...
  public GraphMLImporter(VertexProvider<V> vertexProvider, EdgeProvider<V, E> edgeProvider) {
    ...
    this.delegate =
        new org.jgrapht.io.GraphMLImporter<>(
