 ...
 */
public class DijkstraShortestPathPerformanceTest extends TestCase {
  ...
  public static class ClosestFirstIteratorBenchmark extends BenchmarkBase {
    ...
    ShortestPathAlgorithm<Integer, DefaultWeightedEdge> createSolver(
      ...
      return new ShortestPathAlgorithm<Integer, DefaultWeightedEdge>() {
        ...
        public org.jgrapht.alg.interfaces.ShortestPathAlgorithm.SingleSourcePaths<
                Integer, DefaultWeightedEdge>
            getPaths(Integer source) {
  ...
  public static class ALTBenchmark extends BenchmarkBase {
  ...
  public void testBenchmark() throws RunnerException {
    ...
    System.out.println("---------");
    System.out.println(
        "Using G(n,p) random graph with n = "
