...
public class GnmRandomGraphGeneratorTest {
  ...
  public void testDirectedGraphGnp1() {
    ...
    int[][] edges = {
      {6, 5}, {1, 6}, {5, 6}, {3, 4}, {6, 4}, {2, 1}, {3, 5}, {1, 2}, {1, 3}, {2, 5}, {4, 3},
      {2, 3}, {5, 4}, {1, 4}, {2, 6}, {6, 1}, {4, 6}, {3, 1}
    };
  ...
  public void testDirectedGraphGnp1WithLoops() {
    ...
    int[][] edges = {
      {6, 5}, {3, 3}, {1, 6}, {5, 6}, {3, 4}, {6, 4}, {2, 1}, {3, 5}, {1, 2}, {1, 3}, {2, 5},
      {4, 3}, {2, 3}, {2, 2}, {5, 4}, {2, 2}, {1, 4}, {5, 5}
    };
  ...
  public void testDirectedGraphGnp1WithMultipleEdges() {
    ...
    int[][] edges = {
      {6, 5}, {1, 6}, {5, 6}, {3, 4}, {6, 4}, {2, 1}, {3, 5}, {1, 2}, {6, 4}, {1, 6}, {1, 3},
      {2, 5}, {3, 4}, {4, 3}, {2, 3}, {2, 3}, {5, 4}, {1, 6}
    };
    assertEquals(6, g.vertexSet().size());
    for (int[] e : edges) {
      assertTrue(g.containsEdge(e[0], e[1]));
  ...
  public void testDirectedGraphGnp1WithLoopsAndMultipleEdges() {
    ...
    int[][] edges = {
      {6, 5}, {3, 3}, {1, 6}, {5, 6}, {3, 4}, {6, 4}, {2, 1}, {3, 5}, {1, 2}, {6, 4}, {1, 6},
      {1, 3}, {2, 5}, {3, 4}, {4, 3}, {2, 3}, {2, 2}, {2, 3}
    };
    assertEquals(6, g.vertexSet().size());
    for (int[] e : edges) {
      assertTrue(g.containsEdge(e[0], e[1]));
  ...
  public void testUndirectedGraphGnp1() {
    ...
    int[][] edges = {
      {6, 5}, {1, 6}, {3, 4}, {6, 4}, {2, 1}, {3, 5}, {1, 3}, {2, 5}, {2, 3}, {5, 4}, {1, 4},
      {2, 6}, {5, 1}, {4, 2}, {6, 3}
    };
  ...
  public void testUndirectedGraphGnp1WithLoops() {
    ...
    int[][] edges = {
      {6, 5}, {3, 3}, {1, 6}, {3, 4}, {6, 4}, {2, 1}, {3, 5}, {1, 3}, {2, 5}, {2, 3}, {2, 2},
      {5, 4}, {2, 2}, {1, 4}, {5, 5}
    };
  ...
  /**
   * Generates 4 graphs with the same numOfVertex and numOfEdges. The first two are generated using
   * the same RandomGraphGenerator; the last two are generated using a new instance.
   *
  ...
  static class EdgeTopologyCompare<V, E> {
    /**
     * Compare topology of the two graphs. It does not compare the contents of the vertexes/edges,
     * but only the relationships between them.
     *
     * @param g1
     * @param g2
     */
  ...
  static class VertexOrdering<V, E> {
    ...
    private static class LabelsEdge {
      ...
      public boolean equals(Object obj) {
        ...
        else if (!(obj instanceof VertexOrdering.LabelsEdge)) return false;
