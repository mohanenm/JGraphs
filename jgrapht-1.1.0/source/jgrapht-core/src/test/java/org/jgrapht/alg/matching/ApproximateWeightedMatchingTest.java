 ...
 */
public abstract class ApproximateWeightedMatchingTest extends TestCase {
  ...
  public void testBnGraph() {
    ...
    for (int size = 1; size < 100; size++) {
      ...
      MatchingAlgorithm<Integer, DefaultWeightedEdge> maxAlg = getApproximationAlgorithm(graph);
