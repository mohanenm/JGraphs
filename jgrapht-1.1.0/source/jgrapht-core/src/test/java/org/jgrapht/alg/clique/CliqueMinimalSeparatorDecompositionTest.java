 ...
 */
public class CliqueMinimalSeparatorDecompositionTest extends TestCase {
  ...
  public void testBerry2010() {
    ...
    for (Set<String> atom : cmsd.getAtoms()) {
      if (atom.equals(new HashSet<>(Arrays.asList(new String[] {"a", "b", "c", "k"})))) {
        atom1found = true;
      } else if (atom.equals(new HashSet<>(Arrays.asList(new String[] {"c", "d", "j", "k"})))) {
        atom2found = true;
      } else if (atom.equals(new HashSet<>(Arrays.asList(new String[] {"h", "i", "j", "k"})))) {
        atom3found = true;
      } else if (atom.equals(
    ...
    for (Set<String> separator : cmsd.getSeparators()) {
      ...
      } else if (separator.equals(new HashSet<>(Arrays.asList(new String[] {"d", "j", "k"})))) {
   ...
   * 10.1016/0012-365X(85)90051-2 <a
   * href="http://www.sciencedirect.com/science/article/pii/0012365X85900512">
  ...
  public void testTarjan1985() {
    ...
    for (Set<String> atom : cmsd.getAtoms()) {
      if (atom.equals(new HashSet<>(Arrays.asList(new String[] {"a", "c", "d", "f"})))) {
        atom1found = true;
      } else if (atom.equals(new HashSet<>(Arrays.asList(new String[] {"b", "c", "g", "h"})))) {
        atom2found = true;
      } else if (atom.equals(new HashSet<>(Arrays.asList(new String[] {"d", "e", "i", "j"})))) {
        atom3found = true;
      } else if (atom.equals(
   ...
   *
   * <p><img src="CliqueMinimalSeparatorDecomposition1.jpg" />
   */
  public void testGraph1() {
    ...
    for (Set<String> atom : cmsd.getAtoms()) {
      if (atom.equals(new HashSet<>(Arrays.asList(new String[] {"a", "b", "d", "e"})))) {
        ...
        atomsFound[4] = true;
      } else if (atom.equals(new HashSet<>(Arrays.asList(new String[] {"e", "f", "j", "k"})))) {
        atomsFound[5] = true;
    ...
    for (int i = 0; i < atomsFound.length; ++i) assertTrue("atom " + i, atomsFound[i]);
    ...
    assertEquals(
        2,
        cmsd.getFullComponentCount()
            .get(new HashSet<>(Arrays.asList(new String[] {"d", "e"})))
            .intValue());

    assertEquals(
        2,
        cmsd.getFullComponentCount()
            .get(new HashSet<>(Arrays.asList(new String[] {"e"})))
            .intValue());

    assertEquals(
        3,
        cmsd.getFullComponentCount()
            .get(new HashSet<>(Arrays.asList(new String[] {"d", "i"})))
            .intValue());

    assertEquals(
        2,
        cmsd.getFullComponentCount()
            .get(new HashSet<>(Arrays.asList(new String[] {"i"})))
            .intValue());

    assertEquals(
        2,
        cmsd.getFullComponentCount()
            .get(new HashSet<>(Arrays.asList(new String[] {"e", "j"})))
            .intValue());

    assertEquals(
        3,
        cmsd.getFullComponentCount()
            .get(new HashSet<>(Arrays.asList(new String[] {"i", "j"})))
            .intValue());
  }
  ...
  private static <V, E> boolean isClique(Graph<V, E> graph, Set<V> vertices) {
    for (V v1 : vertices) {
      for (V v2 : vertices) {
        if (v1 != v2 && graph.getEdge(v1, v2) == null) return false;
      }
    }
    return true;
  }
