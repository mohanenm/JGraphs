 ...
 */
public class DirectedAcyclicGraphPerformanceTest extends TestCase {
  ...
  private static class ArrayDAG<V, E> extends DirectedAcyclicGraph<V, E> {
    ...
    public ArrayDAG(Class<? extends E> edgeClass) {
      super(
          new ClassBasedEdgeFactory<>(edgeClass),
          new VisitedArrayImpl(),
          new TopoVertexBiMap<>(),
          false);
    }
  }
