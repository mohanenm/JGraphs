 ...
 *
 * <p>Note: Currently the tests are performed on a single graph. It would be better to run it on
...
public class GraphPerformanceTest extends TestCase {
  ...
  private abstract static class DirectedGraphBenchmarkBase {
  ...
  /**
   * Graph class which relies on the FastLookupDirectedSpecifics. This class is optimized to perform
   * quick edge retrievals.
   */
