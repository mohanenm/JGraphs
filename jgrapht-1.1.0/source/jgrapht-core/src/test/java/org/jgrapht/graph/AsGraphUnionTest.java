 ...
 * @since Aug 24, 2015
 */
public class AsGraphUnionTest extends TestCase {
  ...
  public void testWeightCombiner() {
    ...
    GraphUnion<Integer, DefaultWeightedEdge, Graph<Integer, DefaultWeightedEdge>> graphUnionSum =
        new GraphUnion<>(g1, g2Masked, WeightCombiner.SUM);
    assertEquals(30.0, graphUnionSum.getEdgeWeight(edge));
    GraphUnion<Integer, DefaultWeightedEdge, Graph<Integer, DefaultWeightedEdge>> graphUnionFirst =
        new GraphUnion<>(g1, g2Masked, WeightCombiner.FIRST);
    assertEquals(10.0, graphUnionFirst.getEdgeWeight(edge));
    GraphUnion<Integer, DefaultWeightedEdge, Graph<Integer, DefaultWeightedEdge>> graphUnionSecond =
        new GraphUnion<>(g1, g2Masked, WeightCombiner.SECOND);
    assertEquals(20.0, graphUnionSecond.getEdgeWeight(edge));
    GraphUnion<Integer, DefaultWeightedEdge, Graph<Integer, DefaultWeightedEdge>> graphUnionMax =
        new GraphUnion<>(g1, g2Masked, WeightCombiner.MAX);
    assertEquals(20.0, graphUnionMax.getEdgeWeight(edge));
    GraphUnion<Integer, DefaultWeightedEdge, Graph<Integer, DefaultWeightedEdge>> graphUnionMin =
        new GraphUnion<>(g1, g2Masked, WeightCombiner.MIN);
    assertEquals(10.0, graphUnionMin.getEdgeWeight(edge));
    GraphUnion<Integer, DefaultWeightedEdge, Graph<Integer, DefaultWeightedEdge>> graphUnionMult =
