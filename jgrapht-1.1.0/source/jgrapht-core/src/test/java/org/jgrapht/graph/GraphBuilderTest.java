...
public class GraphBuilderTest extends EnhancedTestCase {
  // ~ Instance fields --------------------------------------------------------
  ...
  public void testAddVertexOldInterfaces() {
    Graph<String, DefaultEdge> g =
        new DirectedGraphBuilder<>(new DefaultDirectedGraph<String, DefaultEdge>(DefaultEdge.class))
            .addVertex(v1)
            .addVertices(v2, v3)
            .build();
  ...
  public void testAddVertexPseudograph() {
    Pseudograph<String, DefaultEdge> g =
        Pseudograph.<String, DefaultEdge>createBuilder(DefaultEdge.class).addVertex(v1).build();
