...
public class BidirectionalDijkstraShortestPathTest extends TestCase {
  ...
  public void testSingleEdgePath() {
    ...
    GraphPath<String, DefaultEdge> p = new BidirectionalDijkstraShortestPath<>(g).getPath("1", "2");
  ...
  public void testSimple1() {
    ...
    GraphPath<String, DefaultEdge> p = new BidirectionalDijkstraShortestPath<>(g).getPath("4", "1");
  ...
  public void testRandomGraphsWeightedUndirected() {
    ...
    for (String v : g.vertexSet()) {
      for (String u : g.vertexSet()) {
        GraphPath<String, DefaultWeightedEdge> p1 = new DijkstraShortestPath<>(g).getPath(v, u);
  ...
  public void testRandomGraphsDirectedWithRadius() {
    ...
    for (String v : g.vertexSet()) {
      for (String u : g.vertexSet()) {
        GraphPath<String, DefaultEdge> p1 = new DijkstraShortestPath<>(g, radius).getPath(v, u);
