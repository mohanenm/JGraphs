...
public class WeightedVertexCoverTest extends VertexCoverTest {
  ...
  public static void testExactMinimumCover1() {
    int[] weightArray = {
      18, 16, 13, 14, 12, 0, 20, 11, 10, 10, 10, 6, 6, 12, 15, 6, 24, 2, 6, 6, 12, 7, 6, 11, 23, 3,
      5, 23, 4, 24, 22, 17, 24, 7, 15, 14, 23, 12, 3, 18, 3, 20, 3, 5, 19, 25, 8, 13, 22, 0, 20, 7,
      21, 9, 0, 6, 0, 18, 16, 1
    };
    ...
    for (int[] edge : edges) Graphs.addEdgeWithVertices(graph, edge[0], edge[1]);

    HashMap<Integer, Double> weights = new HashMap<Integer, Double>();
    for (int i = 0; i < weightArray.length; i++) weights.put(i, Double.valueOf(weightArray[i]));
  ...
  public static void testExactMinimumCover2() {
    int[] weightArray = {
      13, 11, 3, 5, 16, 0, 16, 16, 14, 25, 15, 23, 4, 12, 23, 20, 19, 12, 15, 18, 25, 15, 9, 2, 20,
      6, 21, 17, 16, 21, 20, 9, 0, 23, 7, 24, 17, 15, 19, 12, 4, 13, 1, 19, 7, 22, 20, 6, 13, 2, 5,
      19, 4, 0, 11, 16, 13, 1, 15, 25
    };
  ...
  public static void testExactMinimumCover3() {
    int[] weightArray = {
      20, 15, 16, 0, 20, 7, 1, 25, 0, 23, 6, 7, 8, 11, 3, 18, 25, 12, 20, 18, 24, 10, 9, 25, 0, 9,
      22, 18, 23, 17, 23, 3, 12, 8, 9, 21, 2, 0, 20, 0, 14, 6, 13, 16, 17, 25, 5, 10, 20, 4, 16, 0,
      5, 21, 9, 7, 12, 15, 5, 25
    };
  ...
  public static void testExactMinimumCover4() {
    int[] weightArray = {
      0, 20, 10, 0, 0, 15, 18, 20, 12, 18, 1, 13, 1, 25, 14, 6, 10, 16, 18, 10, 12, 24, 22, 23, 3,
      13, 9, 21, 5, 17, 22, 20, 13, 12, 22, 4, 5, 18, 0, 14, 25, 6, 1, 18, 22, 15, 4, 6, 13, 10, 2,
      21, 24, 16, 6, 6, 23, 9, 9, 2
    };
  ...
  public static void testExactMinimumCover5() {
    int[] weightArray = {
      1, 10, 13, 17, 0, 25, 4, 15, 8, 14, 20, 23, 10, 2, 21, 10, 4, 18, 4, 20, 25, 5, 20, 19, 11,
      15, 18, 8, 19, 3, 3, 24, 3, 8, 6, 12, 8, 12, 2, 8, 2, 1, 5, 23, 11, 18, 22, 6, 19, 0, 19, 11,
      4, 24, 24, 5, 11, 16, 24, 10
    };

    int[][] edges = {
      {0, 30}, {3, 4}, {6, 15}, {7, 10}, {9, 56}, {13, 42}, {19, 49}, {22, 44}, {47, 58}
    };
  ...
  public static void testExactMinimumCover6() {
    int[] weightArray = {
      11, 11, 17, 25, 16, 9, 11, 5, 5, 18, 21, 3, 15, 12, 7, 14, 14, 10, 19, 12, 21, 17, 8, 0, 1, 3,
      21, 8, 23, 0, 23, 7, 2, 1, 24, 18, 4, 25, 22, 6, 3, 10, 7, 4, 0, 24, 5, 16, 5, 8, 19, 11, 5,
      14, 15, 19, 18, 3, 5, 3
    };
  ...
  public static void testExactMinimumCover7() {
    int[] weightArray = {
      24, 13, 20, 22, 17, 18, 14, 3, 10, 10, 3, 13, 25, 3, 24, 7, 12, 24, 20, 11, 11, 14, 10, 7, 16,
      0, 20, 16, 25, 24, 4, 3, 23, 14, 5, 7, 21, 17, 25, 24, 9, 22, 13, 19, 20, 21, 21, 24, 22, 20,
      5, 12, 18, 14, 2, 4, 9, 24, 1, 1
    };
  ...
  public static void testExactMinimumCover8() {
    int[] weightArray = {
      19, 24, 0, 19, 17, 12, 15, 4, 22, 23, 6, 21, 19, 20, 3, 18, 22, 19, 2, 4, 19, 8, 23, 15, 21,
      12, 4, 1, 21, 23, 11, 8, 18, 6, 11, 14, 0, 4, 11, 11, 22, 2, 1, 11, 0, 21, 20, 12, 13, 0, 16,
      15, 24, 12, 15, 4, 24, 3, 20, 8
    };
  ...
  public static void testExactMinimumCover9() {
    int[] weightArray = {
      19, 0, 13, 1, 2, 18, 3, 17, 5, 13, 1, 17, 20, 7, 18, 21, 9, 13, 11, 23, 4, 8, 14, 22, 13, 10,
      4, 17, 0, 8, 24, 6, 3, 3, 8, 25, 20, 4, 19, 19, 4, 11, 3, 2, 9, 18, 10, 23, 15, 2, 22, 14, 15,
      3, 2, 15, 19, 5, 2, 11
    };
  ...
  public static void testExactMinimumCover10() {
    int[] weightArray = {
      0, 12, 13, 7, 23, 21, 8, 20, 12, 21, 23, 1, 16, 13, 2, 9, 18, 24, 18, 13, 0, 13, 4, 12, 16,
      23, 5, 13, 15, 14, 15, 18, 23, 17, 23, 9, 12, 0, 16, 21, 7, 13, 9, 21, 16, 12, 22, 5, 16, 6,
      5, 7, 8, 6, 21, 6, 13, 22, 4, 25
    };
  ...
  protected Map<Integer, Double> getRandomVertexWeights(Graph<Integer, DefaultEdge> graph) {
    ...
    for (Integer v : graph.vertexSet()) vertexWeights.put(v, 1.0 * rnd.nextInt(25));
