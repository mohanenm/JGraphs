 ...
 */
public final class EdmondsMaximumCardinalityMatchingTest extends TestCase {
  ...
  public void testGraph14() {
    ...
    int[][] edges = {
      {2, 0}, {2, 6}, {4, 6}, {4, 3}, {6, 7}, {3, 6}, {5, 0}, {2, 5}, {3, 7}, {2, 4}
    };
    for (int[] edge : edges) g.addEdge(edge[0], edge[1]);
  ...
  public void testIsMaximumMatching4() {
    ...
    Matching<Integer, DefaultEdge> m2 =
        new MatchingAlgorithm.MatchingImpl<>(g, new HashSet<>(Collections.singletonList(e12)), 2);
  ...
  public void testIsMaximumMatching2() {
    ...
    int[][] edges = {
      {0, 8}, {9, 7}, {5, 3}, {9, 4}, {3, 2}, {5, 4}, {1, 0}, {3, 8}, {4, 7}, {2, 0}, {8, 5},
      {0, 5}, {8, 1}
    };
  ...
  public void testGraph2() {
    ...
    for (Integer v : graph.vertexSet()) assertTrue(m.isMatched(v));
  }
