...
public class AsUnweightedGraphTest extends EnhancedTestCase {
  ...
  public void testWeightedGraph() {
    ...
    AsUnweightedGraph<String, DefaultWeightedEdge> unweighted = new AsUnweightedGraph<>(undirected);
  ...
  private void checkView(
    ...
    assertEquals(Graph.DEFAULT_EDGE_WEIGHT, unweighted.getEdgeWeight(unweighted.getEdge(v1, v2)));

    Graphs.addEdge(weighted, v2, v3, 5.0);
    assertEquals(Graph.DEFAULT_EDGE_WEIGHT, unweighted.getEdgeWeight(unweighted.getEdge(v2, v3)));

    unweighted.addEdge(v3, v1);
    assertEquals(Graph.DEFAULT_EDGE_WEIGHT, unweighted.getEdgeWeight(unweighted.getEdge(v3, v1)));
