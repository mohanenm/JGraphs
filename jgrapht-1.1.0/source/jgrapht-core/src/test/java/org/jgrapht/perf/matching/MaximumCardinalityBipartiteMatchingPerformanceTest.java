 ...
 */
public class MaximumCardinalityBipartiteMatchingPerformanceTest extends TestCase {

  public static final int PERF_BENCHMARK_VERTICES_COUNT = 2000;
  public static final double PERF_BENCHMARK_EDGES_PROP = 0.7;

  @State(Scope.Benchmark)
  private abstract static class RandomGraphBenchmarkBase {
    ...
    public void setup() {
      if (generator == null) {
        ...
        generator =
            new GnpRandomBipartiteGraphGenerator<>(
                PERF_BENCHMARK_VERTICES_COUNT,
                PERF_BENCHMARK_VERTICES_COUNT / 2,
  ...
  public static class HopcroftKarpBipartiteMatchingBenchmark extends RandomGraphBenchmarkBase {
    @Override
    MatchingAlgorithm<Integer, DefaultEdge> createSolver(
        Graph<Integer, DefaultEdge> graph,
        Set<Integer> firstPartition,
