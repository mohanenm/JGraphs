...
public class GraphsTest {
   ...
   * <p>+--> C | A +--> B +--+ | +--> D
   *
   * <p>Expected graph after removing X:
   *
   * <p>+--> C | A +--> B +--+ | +--> D
   */
  // @formatter:on
   ...
   * <p>A +--> B
   *
   * <p>Expected graph after removing A:
   *
   * <p>B
   */
  // @formatter:on
   ...
   * <p>A +--> B
   *
   * <p>Expected graph after removing B:
   *
   * <p>A
   */
  // @formatter:on
   ...
   * Input:
   *
   * <p>A (source, not part of graph) B (target, already part of graph) C (target, not part of
   * graph)
   *
   * <p>Expected output:
   *
   ...
   * Input:
   *
   * <p>A (target, not part of graph) B (source, already part of graph) C (source, not part of
   * graph)
   *
   * <p>Expected output:
   *
