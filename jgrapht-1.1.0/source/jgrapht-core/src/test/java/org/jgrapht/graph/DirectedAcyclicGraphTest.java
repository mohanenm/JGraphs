...
public class DirectedAcyclicGraphTest {
  ...
  /**
   * more rigorous test of topological iteration order, by assuring that each visited vertex adheres
   * to the definition of topological order, that is that it doesn't have a path leading to any of
   * its predecessors.
   */
  @Test
   ...
   * <p>+--> C | A +--> B +--+ | +--> D
   *
   * <p>Expected output when determining ancestors of C (order does not matter):
   *
   * <p>B, A
   */
  // @formatter:on
   ...
   * <p>+--> C | A +--> B +--+ | +--> D
   *
   * <p>Expected output when determining ancestors of A:
   *
   * <p><empty list>
   */
  // @formatter:on
   ...
   * <p>A +--> B +--> C | ^ | | +-------------+
   *
   * <p>Expected output when determining ancestors of A (order does not matter):
   *
   * <p>B, A
   */
  // @formatter:on
   ...
   * <p>+--> C | A +--> B +--+ | +--> D
   *
   * <p>Expected output when determining descendents of B (order does not matter):
   *
   * <p>C, D
   */
  // @formatter:on
   ...
   * <p>+--> C | A +--> B +--+ | +--> D
   *
   * <p>Expected output when determining descendents of C:
   *
   * <p><empty list>
   */
  // @formatter:on
  ...
  public static class LongVertexFactory implements VertexFactory<Long> {
