...
public abstract class BasePathGrowingWeightedMatchingTest extends ApproximateWeightedMatchingTest {
  ...
  public void testDynamicProgrammingOnPaths() {
    ...
    PathGrowingWeightedMatching<Integer, DefaultWeightedEdge>.DynamicProgrammingPathSolver
        pathSolver = pathGrowingAlgo.new DynamicProgrammingPathSolver();
    Pair<Double, Set<DefaultWeightedEdge>> result = pathSolver.getMaximumWeightMatching(g, path);
    ...
    Pair<Double, Set<DefaultWeightedEdge>> result1 = pathSolver.getMaximumWeightMatching(g, path1);
    ...
    Pair<Double, Set<DefaultWeightedEdge>> result2 = pathSolver.getMaximumWeightMatching(g, path2);
    ...
    Pair<Double, Set<DefaultWeightedEdge>> result3 = pathSolver.getMaximumWeightMatching(g, path3);
  ...
  public void testApproximationFactorOnRandomInstances() {
    ...
    for (int i = 0; i < repeat; i++) {
      ...
      MatchingAlgorithm<Integer, DefaultWeightedEdge> alg1 = new PathGrowingWeightedMatching<>(g);
