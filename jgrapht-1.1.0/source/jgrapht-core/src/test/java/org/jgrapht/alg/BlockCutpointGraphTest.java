...
public class BlockCutpointGraphTest extends TestCase {
  ...
  public void testBiconnected() {
    ...
    BlockCutpointGraph<String, DefaultEdge> blockCutpointGraph = new BlockCutpointGraph<>(graph);
  ...
  public <V> void testGetBlock(BlockCutpointGraph<V, DefaultEdge> blockCutpointGraph) {
    for (Graph<V, DefaultEdge> component : blockCutpointGraph.vertexSet()) {
      if (!component.edgeSet().isEmpty()) {
        ...
        assertTrue(
            blockCutpointGraph.getCutpoints().contains(component.vertexSet().iterator().next()));
      }
    }
  }
  ...
  public void testLinearGraph(int nbVertices) {
    ...
    LinearGraphGenerator<Object, DefaultEdge> generator = new LinearGraphGenerator<>(nbVertices);
