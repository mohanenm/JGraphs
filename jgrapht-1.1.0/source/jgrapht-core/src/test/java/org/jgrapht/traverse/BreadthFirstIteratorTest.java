 ...
 *
 * <p>NOTE: This test uses hard-coded expected ordering isn't really guaranteed by the specification
 * of the algorithm. This could cause false failures if the traversal implementation changes.
 *
...
public class BreadthFirstIteratorTest extends CrossComponentIteratorTest {
  ...
  AbstractGraphIterator<String, DefaultWeightedEdge> createIterator(
    ...
    AbstractGraphIterator<String, DefaultWeightedEdge> i = new BreadthFirstIterator<>(g, vertex);
