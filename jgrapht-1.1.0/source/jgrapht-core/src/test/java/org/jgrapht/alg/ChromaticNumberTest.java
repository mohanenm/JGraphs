...
public class ChromaticNumberTest extends TestCase {
  ...
  public void testChromaticNumber() {
    ...
    CompleteGraphGenerator<Object, DefaultEdge> completeGenerator = new CompleteGraphGenerator<>(7);
    ...
    linearGenerator.generateGraph(linearGraph, new ClassBasedVertexFactory<>(Object.class), null);
