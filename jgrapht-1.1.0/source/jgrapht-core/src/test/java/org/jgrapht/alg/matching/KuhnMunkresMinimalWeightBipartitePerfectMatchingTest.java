...
public class KuhnMunkresMinimalWeightBipartitePerfectMatchingTest {
  ...
  private static Matching<V, WeightedEdge> match(
    ...
    return new KuhnMunkresMinimalWeightBipartitePerfectMatching<V, WeightedEdge>(
            target, new LinkedHashSet<>(first), new LinkedHashSet<>(second))
        .getMatching();
  }
  ...
  public void test5x5AssignmentTask() {
    ...
    double[][] costMatrix =
        new double[][] {
          {1, 2, 3, 4, 5}, {6, 7, 8, 7, 2}, {1, 3, 4, 4, 5}, {3, 6, 2, 8, 7}, {4, 1, 3, 5, 4}
        };
  ...
  public void test5x5InvertedAssignmentTask() {
    ...
    double[][] costMatrix =
        new double[][] {
          {7, 6, 5, 4, 3}, {2, 1, 0, 1, 6}, {7, 5, 4, 4, 3}, {5, 2, 6, 0, 1}, {4, 7, 5, 3, 4}
        };
  ...
  public void test5x5DegeneratedAssignmentTask() {
    ...
    double[][] costMatrix =
        new double[][] {
          {9, 6, 5, 9, 3}, {2, 1, 0, 1, 6}, {7, 5, 9, 4, 3}, {9, 2, 6, 0, 1}, {4, 9, 5, 9, 4},
        };
    ...
    double[][] costMatrix =
        new double[][] {
          ...
          },
          {
            ...
            374364, 374364, 374364, 374364, 374364, 374364, 374364, 374364, 374364, 374364, 374364
          },
          {
            0, 270959812, 270953498, 270983714, 270900527, 213938, 213938, 213938, 213938, 213938,
            213938, 213938, 213938, 213938, 213938, 213938, 213938, 213938, 213938, 213938, 213938
          },
          {
        ...
        new double[][] {
          {
            ...
            284309466, 284309466, 284309466, 284309466, 284309466, 284309466, 284309466, 284309466,
            284309466, 284309466, 284309466, 284309466
          },
          {
