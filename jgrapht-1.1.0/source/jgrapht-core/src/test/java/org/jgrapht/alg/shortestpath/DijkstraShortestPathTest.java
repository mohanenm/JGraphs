...
public class DijkstraShortestPathTest extends ShortestPathTestCase {
  ...
  public void testConstructor() {
    ...
    path =
        new DijkstraShortestPath<String, DefaultWeightedEdge>(g, Double.POSITIVE_INFINITY)
            .getPath(V3, V4);
    assertEquals(Arrays.asList(new DefaultWeightedEdge[] {e13, e12, e24}), path.getEdgeList());
