...
public class WindmillGraphsGeneratorTest {
  ...
  public void testGraph1a() {
    Graph<Integer, DefaultEdge> g = new SimpleGraph<>(DefaultEdge.class);
    new WindmillGraphsGenerator<Integer, DefaultEdge>(WindmillGraphsGenerator.Mode.WINDMILL, 3, 4)
  ...
  public void testGraph2a() {
    Graph<Integer, DefaultEdge> g = new SimpleGraph<>(DefaultEdge.class);
    new WindmillGraphsGenerator<Integer, DefaultEdge>(WindmillGraphsGenerator.Mode.WINDMILL, 4, 3)
        .generateGraph(g, new IntegerVertexFactory(), null);
  ...
  public void testGraph3a() {
    Graph<Integer, DefaultEdge> g = new SimpleGraph<>(DefaultEdge.class);
    new WindmillGraphsGenerator<Integer, DefaultEdge>(WindmillGraphsGenerator.Mode.WINDMILL, 3, 5)
        .generateGraph(g, new IntegerVertexFactory(), null);
