 ...
 * al. An Introduction to Clique Minimal Separator Decomposition (2010), DOI:10.3390/a3020197, <a
 * href="http://www.mdpi.com/1999-4893/3/2/197">http://www.mdpi.com/1999-4893/3/2/197</a>
 *
 * <p>The Clique Minimal Separator (CMS) Decomposition is a procedure that splits a graph into a set
 * of subgraphs separated by minimal clique separators, adding the separating clique to each
 * component produced by the separation. At the end we have a set of atoms. The CMS decomposition is
 * unique and yields the set of the atoms independent of the order of the decomposition.
 *
...
public class CliqueMinimalSeparatorDecomposition<V, E> {
   ...
   * a minimal separator of triangulated graph.
   *
