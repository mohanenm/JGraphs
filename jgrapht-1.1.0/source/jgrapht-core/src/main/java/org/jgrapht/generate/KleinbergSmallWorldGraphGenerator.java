 ...
 *
 * <p>The generator is described in the paper: J. Kleinberg, The Small-World Phenomenon: An
 * Algorithmic Perspective, in Proc. 32nd ACM Symp. Theory of Comp., 163-170, 2000.
 *
 * <p>The basic structure is a a two-dimensional grid and allows for edges to be directed. It begins
...
public class KleinbergSmallWorldGraphGenerator<V, E> implements GraphGenerator<V, E, V> {
   ...
   * @param r probability distribution parameter which is a basic structural parameter measuring how
