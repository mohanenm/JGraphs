 ...
 *
 * <p>The <a href="https://en.wikipedia.org/wiki/PageRank">wikipedia</a> article contains a nice
 ...
 * Conference, Brisbane, Australia, April 1998. See also the following <a
 * href="http://infolab.stanford.edu/~backrub/google.html">page</a>.
 *
 * <p>This is a simple iterative implementation of PageRank which stops after a given number of
 ...
 *
 * <p>Each iteration of the algorithm runs in linear time O(n+m) when n is the number of nodes and m
 ...
 *
 * <p>If the graph is a weighted graph, a weighted variant is used where the probability of
 * following an edge e out of node v is equal to the weight of e over the sum of weights of all
 * outgoing edges of v.
 *
...
public final class PageRank<V, E> implements VertexScoringAlgorithm<V, Double> {
  ...
  /**
   * Default value for the tolerance. The calculation will stop if the difference of PageRank values
