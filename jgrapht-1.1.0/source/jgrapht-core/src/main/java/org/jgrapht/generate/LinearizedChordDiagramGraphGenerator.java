 ...
 *
 * <p>The generator makes precise several unspecified mathematical details of the Barabási-Albert
 ...
 *
 * <p>In contrast with the Barabási-Albert model, the model of Bollobás and Riordan allow for
 * multiple edges (parallel-edges) and self-loops. They show, however, that their number will be
 * small. This means that this generator works only on graphs which allow multiple edges
 * (parallel-edges) such as {@link Pseudograph} or {@link DirectedPseudograph}.
 *
 * <p>The generator starts with a graph of one node and grows the network by adding n-1 additional
