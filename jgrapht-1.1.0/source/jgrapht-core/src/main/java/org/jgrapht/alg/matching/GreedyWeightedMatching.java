 ...
 * zero.
 *
 * <p>This algorithm can be run in two modes: with and without edge cost normalization. Without
 ...
 *
 * <p>For more information about approximation algorithms for the maximum weight matching problem in
 * arbitrary graphs see:
 *
 * <ul>
 *   <li>R. Preis, Linear Time 1/2-Approximation Algorithm for Maximum Weighted Matching in General
 *       Graphs. Symposium on Theoretical Aspects of Computer Science, 259-269, 1999.
