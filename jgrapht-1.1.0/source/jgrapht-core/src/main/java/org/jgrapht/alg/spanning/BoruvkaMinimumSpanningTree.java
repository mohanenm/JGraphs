 ...
 *
 * <p>See the article on <a
 * href="https://en.wikipedia.org/wiki/Bor%C5%AFvka%27s_algorithm">wikipedia</a> for more
 * information on the history of the algorithm.
 *
 * <p>This implementation uses a union-find data structure (with union by rank and path compression
