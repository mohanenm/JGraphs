...
public class HopcroftKarpBipartiteMatching<V, E> implements MatchingAlgorithm<V, E> {
   ...
   * partition 1, check whether there is an edge to an exposed vertex in partition 2. If so, add the
   * edge to the matching.
   */
  ...
  /**
   * This method is the main method of the class. First it finds a greedy matching. Next it tries to
   * improve the matching by finding all the augmenting paths. This leads to a maximum matching.
   */
