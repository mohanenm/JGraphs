 ...
 * "http://mathworld.wolfram.com/Scale-FreeNetwork.html">scale-free network</a> of any size.
 * Scale-free network is a connected graph, where degrees of vertices are distributed in unusual
 * way. There are many vertices with small degrees and only small amount of vertices with big
 * degrees.
 *
