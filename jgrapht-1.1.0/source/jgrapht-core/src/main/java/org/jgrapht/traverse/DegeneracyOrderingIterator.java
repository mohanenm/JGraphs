 ...
 *
 * <p>The degeneracy of a graph G is the smallest value d such that every nonempty subgraph of G
 ...
 * ordering.
 *
 * <p>The iterator crosses components but does not track them, it only tracks visited vertices.
 *
 * <p>The iterator treats the input graph as undirected even if the graph is directed. Moreover, it
