 ...
 *
 * <p>This is an implementation of the folklore algorithm which returns a depth-first ordering of
 * the minimum spanning tree. The algorithm is a 2-approximation assuming that the instance
 * satisfies the triangle inequality. The implementation requires the input graph to be undirected
 * and complete. The running time is O(|V|^2 log|V|).
 *
 * <p>See <a href="https://en.wikipedia.org/wiki/Travelling_salesman_problem">wikipedia</a> for more
 * details.
 *
 ...
 */
public class TwoApproxMetricTSP<V, E> implements TSPAlgorithm<V, E> {
