...
public class GeneralizedPetersenGraphGenerator<V, E> implements GraphGenerator<V, E, List<V>> {
   ...
   * @param resultMap if non-null, the resultMap contains a mapping from the key "star" to a list of
   *     vertices constituting the star polygon, as well as a key "regular" which maps to a list of
   *     vertices constituting the regular polygon.
   */
  @Override
