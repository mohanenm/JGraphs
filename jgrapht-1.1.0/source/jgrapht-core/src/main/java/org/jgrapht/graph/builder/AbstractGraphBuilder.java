...
public abstract class AbstractGraphBuilder<
    V, E, G extends Graph<V, E>, B extends AbstractGraphBuilder<V, E, G, B>> {
  ...
  /**
   * Adds an weighted edge to the graph being built. The source and target vertices are added to the
  ...
  /**
   * Build an unmodifiable version graph. Calling any method (including this method) on this builder
   * object after calling this method is undefined behaviour.
   *
