 ...
 *
 * <p>The implementation is described in the paper: Michael D. Vose. A Linear Algorithm for
 * Generating Random Numbers with a Given Distribution. IEEE Transactions on Software Engineering,
 * 17(9):972--975, 1991.
 *
 * <p>Initialization takes O(n) where n is the number of items. Sampling takes O(1).
 *
