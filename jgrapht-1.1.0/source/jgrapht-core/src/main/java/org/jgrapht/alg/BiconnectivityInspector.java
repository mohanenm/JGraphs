...
public class BiconnectivityInspector<V, E> {
  ...
  /**
   * Returns the biconnected vertex-components containing the vertex. A biconnected vertex-component
   * contains all the vertices in the component. A vertex which is not a cutpoint is contained in
   * exactly one component. A cutpoint is contained is at least 2 components.
   *
