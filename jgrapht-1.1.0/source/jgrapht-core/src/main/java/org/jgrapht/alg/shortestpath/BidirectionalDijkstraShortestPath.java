 ...
 *
 * <p>See the Wikipedia article for details and references about <a
 * href="https://en.wikipedia.org/wiki/Bidirectional_search">bidirectional search</a>. This
...
public final class BidirectionalDijkstraShortestPath<V, E> extends BaseShortestPathAlgorithm<V, E> {
  ...
  private GraphPath<V, E> createPath(
      SearchFrontier forwardFrontier,
      SearchFrontier backwardFrontier,
      double weight,
      V source,
      V commonVertex,
