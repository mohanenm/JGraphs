...
public interface MaximumFlowAlgorithm<V, E> {
   ...
   * flow from <tt>source</tt> to <tt>sink</tt>. Returns an object containing detailed information
   * about the flow.
   *
   ...
   * call.
   *
   * <p>NOTE: this function currently has a default implementation to guarantee backwards
   ...
   * @param <E> the graph edge type
   */
  class MaximumFlowImpl<E> implements MaximumFlow<E> {
