 ...
 *
 * <p><b>Note that this implementation is not synchronized.</b> If multiple threads access a set
 ...
 *
 * <p>This class was originally developed by Nathan Fiedler for the GraphMaker project. It was
 * imported to JGraphT with permission, courtesy of Nathan Fiedler.
 *
...
public class FibonacciHeap<T> {
   ...
   *
   * <p>Running time: O(log n) amortized
   *
   ...
   *
   * <p>Running time: O(log n); O(1) excluding the recursion
   *
