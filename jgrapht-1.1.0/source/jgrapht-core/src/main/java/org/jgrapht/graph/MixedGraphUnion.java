 ...
 *
 * <p>Since this graph is a union of an undirected and a directed graph, calls to method {@link
 * MixedGraphUnion#incomingEdgesOf(Object)} and/or {@link MixedGraphUnion#outgoingEdgesOf(Object)}
 * might return edges having their source and target vertices in the opposite order. Similarly
 * methods {@link MixedGraphUnion#degreeOf(Object)}, {@link MixedGraphUnion#inDegreeOf(Object)} and
 * {@link MixedGraphUnion#outDegreeOf(Object)} will return the sum of the degrees in the underlying
 * graphs.
 *
 ...
 */
@Deprecated
public class MixedGraphUnion<V, E> extends GraphUnion<V, E, Graph<V, E>>
  ...
  /**
   * Construct a new graph union. The union will use the {@link WeightCombiner#SUM} weight combiner.
   *
   * @param g1 the undirected graph
   * @param g2 the directed graph
   */
