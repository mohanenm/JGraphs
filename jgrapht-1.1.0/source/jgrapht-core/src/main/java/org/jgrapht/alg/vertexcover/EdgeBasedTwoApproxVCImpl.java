 ...
 *
 * <p>Note: this class supports pseudo-graphs
 *
...
public class EdgeBasedTwoApproxVCImpl<V, E> implements MinimumVertexCoverAlgorithm<V, E> {
   ...
   * promises a cover that is at most double the size of a minimal cover. The algorithm takes O(|E|)
   * time.
   *
   * <p>Note: this class supports pseudo-graphs Runtime: O(|E|)
   *
   * <p>Albeit the fact that this is a 2-approximation algorithm for vertex cover, its results are
   * often of lower quality than the results produced by {@link BarYehudaEvenTwoApproxVCImpl} or
   * {@link ClarksonTwoApproxVCImpl}.
   *
   * <p>For more details see Jenny Walter, CMPU-240: Lecture notes for Language Theory and
