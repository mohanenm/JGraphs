 ...
 *
 * <p>Read-only union of two graphs: G<sub>1</sub> and G<sub>2</sub>. If G<sub>1</sub> =
...
public class AsGraphUnion<V, E> extends AbstractGraph<V, E> implements Serializable {
   ...
   * {@inheritDoc}
   *
   * <p>Note that this operation might by expensive as it involves copying the edge sets of the two
   * underlying graphs.
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * <p>Note that this operation might by expensive as it currently involves copying the vertex sets
