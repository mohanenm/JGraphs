...
abstract class BaseBronKerboschCliqueFinder<V, E>
  ...
  /**
   * Create an iterator which returns only the maximum cliques of a graph. The iterator computes all
   * maximal cliques and then filters them by the size of the maximum found clique.
   *
