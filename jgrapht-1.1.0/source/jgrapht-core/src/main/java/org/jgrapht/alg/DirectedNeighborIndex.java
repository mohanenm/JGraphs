 ...
 *
 * <p>A vertex's neighbors are cached the first time they are asked for (i.e. the index is built on
...
public class DirectedNeighborIndex<V, E> implements GraphListener<V, E> {
  ...
  /**
   * Returns the set of vertices which are the predecessors of a specified vertex. The returned set
  ...
  /**
   * Returns the set of vertices which are the predecessors of a specified vertex. If the graph is a
   ...
   * duplicating entries in the neighbor set. It is thus more efficient to use {@link
  ...
  /**
   * Returns the set of vertices which are the successors of a specified vertex. The returned set is
