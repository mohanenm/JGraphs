 ...
 *
 * <p>The algorithm is a variant of the Bron-Kerbosch algorithm which apart from the pivoting uses a
 ...
 * </ul>
 *
 * <p>and has running time O(d n 3^{d/3}) where n is the number of vertices of the graph and d is
