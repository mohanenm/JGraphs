 ...
 *
 * <p>In the G(n, p) model, a graph is constructed by connecting nodes randomly. Each edge is
 * included in the graph with probability p independent from every other edge. The complexity of the
 * generator is O(n^2) where n is the number of vertices.
 *
 * <p>For the G(n, M) model please see {@link GnmRandomGraphGenerator}.
 *
