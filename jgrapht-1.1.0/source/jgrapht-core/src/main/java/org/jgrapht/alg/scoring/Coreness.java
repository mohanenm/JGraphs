 ...
 *
 * <p>A k-core of a graph G is a maximal connected subgraph of G in which all vertices have degree
 * at least k. Equivalently, it is one of the connected components of the subgraph of G formed by
 ...
 *
 * <p>If a non-empty k-core exists, then, clearly, G has <a
 * href="https://en.wikipedia.org/wiki/Degeneracy_(graph_theory)">degeneracy</a> at least k, and the
 * degeneracy of G is the largest k for which G has a k-core.
 *
 * <p>As described in the following paper
 *
 * <ul>
...
public final class Coreness<V, E> implements VertexScoringAlgorithm<V, Integer> {
   ...
   *
   * <p>The degeneracy of a graph is the smallest value of k for which it is k-degenerate. In graph
