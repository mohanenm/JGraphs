...
public class UnorderedPair<A, B> extends Pair<A, B> implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    else if (!(o instanceof UnorderedPair)) return false;
  ...
  /**
   * Creates new unordered pair of elements pulling of the necessity to provide corresponding types
   * of the elements supplied.
   *
