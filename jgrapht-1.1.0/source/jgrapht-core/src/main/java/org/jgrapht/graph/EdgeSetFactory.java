...
/**
 * A factory for edge sets. This interface allows the creator of a graph to choose the {@link
 * java.util.Set} implementation used internally by the graph to maintain sets of edges. This
...
public interface EdgeSetFactory<V, E> {
   ...
   *     ArrayUnenforcedSet for a vertex expected to have low degree, and LinkedHashSet for a vertex
