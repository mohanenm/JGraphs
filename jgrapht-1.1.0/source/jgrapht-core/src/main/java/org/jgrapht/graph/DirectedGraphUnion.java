 ...
 */
@Deprecated
public class DirectedGraphUnion<V, E> extends GraphUnion<V, E, DirectedGraph<V, E>>
  ...
  /**
   * Construct a new directed graph union. The union will use the {@link WeightCombiner#SUM} weight
   * combiner.
   *
   * @param g1 the first graph
   * @param g2 the second graph
