 ...
 *
 * <p>Used by greedy algorithms that need to sort vertices by their degree. Two vertices are
 * considered equal if their degrees are equal.
 *
...
public class VertexDegreeComparator<V, E> implements Comparator<V> {
  ...
  public int compare(V v1, V v2) {
    ...
    if (order == Order.ASCENDING) return comparison;
