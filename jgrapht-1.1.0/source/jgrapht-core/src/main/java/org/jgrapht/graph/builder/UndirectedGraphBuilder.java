...
/**
 * A builder class for {@link Graph}. If you want to extend this class, see {@link
...
public final class UndirectedGraphBuilder<V, E, G extends UndirectedGraph<V, E>>
   ...
   *
   * <p>The recommended way to use this constructor is: {@code new UndirectedGraphBuilder<...>(new
   * YourGraph<...>(...))}.
   *
   * <p>NOTE: {@code baseGraph} should not be an existing graph. If you want to add an existing
   * graph to the graph being built, you should use the {@link #addVertex(Object)} method.
   *
