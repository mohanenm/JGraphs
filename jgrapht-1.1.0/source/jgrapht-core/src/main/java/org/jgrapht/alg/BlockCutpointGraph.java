 ...
 * href="http://www.albany.edu/~goel/publications/rosencrantz2005.pdf">Structure-Based Resilience
 * Metrics for Service-Oriented Networks</a>:
 *
 * <ul>
 ...
 *       (a) VB has one node corresponding to each block and one node corresponding to each cut
 *       point of G. (b) Each edge fx; yg in EB joins a block node x to a cut point y if the block
 ...
 *       share at most one node, and that node is a cutpoint. (b) The BC graph of G is a tree in
