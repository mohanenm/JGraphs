...
/**
 * An algorithm which computes a <a
 * href="https://en.wikipedia.org/wiki/Glossary_of_graph_theory#spanner">graph spanner</a> of a
 * given graph.
 *
...
public interface SpannerAlgorithm<E> {
   ...
   * @param <E> the graph edge type
   */
  class SpannerImpl<E> implements Spanner<E>, Serializable {
