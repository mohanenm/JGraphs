 ...
 *
 * <p>Note: this class supports pseudo-graphs Runtime: O(|E|) This is a fast algorithm, guaranteed
 * to give a 2-approximation. A solution of higher quality (same approximation ratio) at the
 * expensive of a higher runtime can be obtained using {@link BarYehudaEvenTwoApproxVCImpl}.
 *
 * <p>TODO: Remove the UndirectedSubgraph dependency! Querying vertex degrees on these graphs is
...
public class BarYehudaEvenTwoApproxVCImpl<V, E>
  ...
  public VertexCover<V> getVertexCover(Graph<V, E> graph, Map<V, Double> vertexWeightMap) {
    ...
    for (V v : graph.vertexSet()) W.put(v, vertexWeightMap.get(v));
