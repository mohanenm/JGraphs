 ...
 *
 * <p>The user provides the sizes n1 and n2 of the two partitions (n1+n2=n) and the probability p of
...
public class GnpRandomBipartiteGraphGenerator<V, E> implements GraphGenerator<V, E, V> {
  ...
  /**
   * Create a new random bipartite graph generator. The generator uses the G(n, p) model when n = n1
   * + n2 and the bipartite graph has one partition with size n1 and one partition with size n2. An
   * edge between two vertices of different partitions is included with probability p independent of
   * all other edges.
   *
  ...
  /**
   * Create a new random bipartite graph generator. The generator uses the G(n, p) model when n = n1
   * + n2, the bipartite graph has partition with size n1 and a partition with size n2. An edge
   * between two vertices of different partitions is included with probability p independent of all
   * other edges.
   *
   * @param n1 number of vertices of the first partition
   * @param n2 number of vertices of the second partition
