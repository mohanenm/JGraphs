 ...
 *
 * <p>Note: it is not recommended to use this class to calculate the overall minimum cut in a graph
 * by iteratively invoking this class for all source-sink pairs. This is computationally expensive.
...
public interface MinimumSTCutAlgorithm<V, E> {
  ...
  /**
   * Returns the capacity of the cut obtained after the last invocation of {@link
  ...
  /**
   * Returns the source partition S, s ∈ S, of the cut obtained after the last invocation of {@link
   * #calculateMinCut(Object, Object)}
   *
  ...
  /**
   * Returns the sink partition T, t ∈ T, of the cut obtained after the last invocation of {@link
   * #calculateMinCut(Object, Object)}
   *
