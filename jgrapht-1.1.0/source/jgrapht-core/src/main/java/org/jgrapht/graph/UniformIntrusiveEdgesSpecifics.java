 ...
 *
 * <p>The implementation optimizes the use of {@link DefaultEdge} and subclasses. For other custom
 * user edge types, a map is used to store vertex source and target.
 *
 * @author Barak Naveh
 ...
 */
class UniformIntrusiveEdgesSpecifics<V, E> extends BaseIntrusiveEdgesSpecifics<V, E, IntrusiveEdge>
