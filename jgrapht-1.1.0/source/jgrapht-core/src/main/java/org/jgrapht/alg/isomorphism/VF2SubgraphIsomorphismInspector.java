...
/**
 * This is an implementation of the VF2 algorithm using its feature of detecting <a
 * href="http://mathworld.wolfram.com/Vertex-InducedSubgraph.html">subgraph isomorphism between two
 * graphs</a> as described in Cordella et al. A (sub)graph isomorphism algorithm for matching large
 * graphs (2004), DOI:10.1109/TPAMI.2004.75, <a
...
public class VF2SubgraphIsomorphismInspector<V, E> extends VF2AbstractIsomorphismInspector<V, E> {
  ...
  public VF2SubgraphMappingIterator<V, E> getMappings() {
    return new VF2SubgraphMappingIterator<>(ordering1, ordering2, vertexComparator, edgeComparator);
  }
}
