 ...
 *
 * <p>Many classes which implement an iterator face a common problem: if there is no easy way to
 ...
 *
 * <p><b>Usage:</b> The new iterator class will hold this class as a member variable and forward the
