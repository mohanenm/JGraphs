 ...
 *
 * <p>This is the greedy coloring algorithm using saturation degree ordering. The saturation degree
 * of a vertex is defined as the number of different colors to which it is adjacent. The algorithm
 ...
 *
 * <p>Note that the DSatur is not optimal in general, but is optimal for bipartite graphs. Compared
 * to other simpler greedy ordering heuristics, it is usually considered slower but more efficient
 ...
 * </ul>
 *
 * <p>This implementation requires O(n^2) running time and space. The following paper discusses
