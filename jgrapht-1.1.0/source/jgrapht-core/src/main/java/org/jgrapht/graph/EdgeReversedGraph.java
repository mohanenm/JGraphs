 ...
 *
 * <p>This class allows you to use a directed graph algorithm in reverse. For example, suppose you
 * have a directed graph representing a tree, with edges from parent to child, and you want to find
 * all of the parents of a node. To do this, simply create an edge-reversed graph and pass that as
 * input to {@link org.jgrapht.traverse.DepthFirstIterator}.
 *
