...
public abstract class AbstractGraph<V, E> implements Graph<V, E> {
  ...
  /**
   * Returns a hash code value for this graph. The hash code of a graph is defined to be the sum of
   * the hash codes of vertices and edges in the graph. It is also based on graph topology and edges
   * weights.
   *
  ...
  /**
   * Indicates whether some other object is "equal to" this graph. Returns <code>true</code> if the
