 ...
 *
 * <p>This class can also computes minimum s-t cuts. Effectively, to compute a minimum s-t cut, the
...
public class PushRelabelMFImpl<V, E> extends MaximumFlowAlgorithmBase<V, E> {
  ...
  private class PushRelabelDiagnostic {
    ...
    void dump() {
      ...
      Collections.sort(dischargesSorted, (one, other) -> -(one.getValue() - other.getValue()));
