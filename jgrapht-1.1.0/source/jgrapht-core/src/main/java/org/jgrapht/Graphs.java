...
public abstract class Graphs {
  /**
   * Creates a new edge and adds it to the specified graph similarly to the {@link
  ...
  /**
   * Adds the specified source and target vertices to the graph, if not already included, and
   * creates a new weighted edge and adds it to the specified graph similarly to the {@link
   * Graph#addEdge(Object, Object)} method.
   *
   * @param g the graph for which the specified edge to be added
   * @param sourceVertex source vertex of the edge
   ...
   *
   * <p>The behavior of this operation is undefined if any of the specified graphs is modified while
   ...
   * @param <V> the graph vertex type
   * @param <E> the graph edge type
   * @return <code>true</code> if and only if the destination graph has been changed as a result of
   *     this operation.
   */
   ...
   * destination digraph, reversing all of the edges. If you want to do this as a linked view of the
   * source graph (rather than by copying to a destination graph), use {@link EdgeReversedGraph}
   * instead.
   *
   * <p>The behavior of this operation is undefined if any of the specified graphs is modified while
   * operation is in progress.
  ...
  /**
   * Adds all of the specified vertices to the destination graph. The behavior of this operation is
   * undefined if the specified vertex collection is modified while the operation is in progress.
   * This method will invoke the {@link Graph#addVertex(Object)} method.
   *
   * @param destination the graph to which edges are to be added
   ...
   *     if the specified vertex collection is <tt> null</tt>.
   ...
   *
   * <p>The method uses {@link Graph#edgesOf(Object)} to traverse the graph.
   *
  ...
  /**
   * Returns a list of vertices that are the direct predecessors of a specified vertex. If the graph
   * is a multigraph, vertices may appear more than once in the returned list.
   *
   * <p>The method uses {@link Graph#incomingEdgesOf(Object)} to traverse the graph.
   *
   ...
   * is a multigraph vertices may appear more than once in the returned list.
   *
   * <p>The method uses {@link Graph#outgoingEdgesOf(Object)} to traverse the graph.
   *
  ...
  /**
   * Returns an undirected view of the specified graph. If the specified graph is directed, returns
   * an undirected view of it. If the specified graph is already undirected, just returns it.
   *
   * @param g the graph for which an undirected view is to be returned
   * @param <V> the graph vertex type
   * @param <E> the graph edge type
   * @return an undirected view of the specified graph, if it is directed, or or the specified graph
   *     itself if it is already undirected.
   ...
   * predecessors, the predecessors will be connected directly to the successors of the vertex to be
   * removed.
   *
   ...
   *
   * @param graph graph to be mutated
   * @param predicate a non-interfering stateless predicate to apply to each vertex to determine if
   *     it should be removed from the graph
   * @param <V> the graph vertex type
   * @param <E> the graph edge type
   ...
   * more predecessors, the predecessors will be connected directly to the successors of the vertex
   * to be removed.
   *
