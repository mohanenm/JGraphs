...
class KShortestPathsIterator<V, E> implements Iterator<Set<V>> {
   ...
   * traversal info regarding each vertex. Key = vertex, value = <code>RankingPathElementList</code>
   ...
   * @return list of <code>RankingPathElement</code>, or <code>null</code> of no path exists between
