...
public abstract class WeightedGraphGeneratorAdapter<V, E, T> implements GraphGenerator<V, E, T> {
   ...
   * class, the generator may produce a labeling indicating the roles played by generated elements.
   * This is the purpose of the resultMap parameter. For example, a generator for a wheel graph
   * would designate a hub vertex. Role names used as keys in resultMap should be declared as public
   * static final Strings by implementation classes.
   *
