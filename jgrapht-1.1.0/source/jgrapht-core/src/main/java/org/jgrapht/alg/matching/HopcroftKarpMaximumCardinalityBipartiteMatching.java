 ...
 * cardinality matching in general (non-bipartite) graphs, use {@link
 * EdmondsMaximumCardinalityMatching} instead.
 *
 * <p>The Hopcroft Karp matching algorithm computes augmenting paths of increasing length, until no
 ...
 *
 * <p>The original algorithm is described in: Hopcroft, John E.; Karp, Richard M. (1973), "An n5/2
...
public class HopcroftKarpMaximumCardinalityBipartiteMatching<V, E>
   ...
   * must be bipartite. For efficiency reasons, this class does not check whether the input graph is
   * bipartite. Invoking this class on a non-bipartite graph results in undefined behavior. To test
   * whether a graph is bipartite, use {@link GraphTests#isBipartite(Graph)}.
   *
