 ...
 *
 * <p>The generator is described in the paper: D. J. Watts and S. H. Strogatz. Collective dynamics
 * of small-world networks. Nature 393(6684):440--442, 1998.
 *
 * <p>The following paragraph from the paper describes the construction.
 *
 * <p>"The generator starts with a ring of n vertices, each connected to its k nearest neighbors (k
 ...
 *
 * <p>The authors require n » k » ln(n) » 1 and specifically k » ln(n) guarantees that a random
 * graph will be connected.
 *
 * <p>Through the constructor parameter the model can be slightly changed into adding shortcut edges
