 ...
 *
 * <p>NOTE: To run this demo you may need to increase the JVM max mem size. In Sun's JVM it is done
 * using the "-Xmx" switch. Specify "-Xmx300M" to set it to 300MB.
 *
 * <p>WARNING: Don't run this demo as-is on machines with less than 512MB memory. Your machine will
