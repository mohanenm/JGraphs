 ...
 *
 * <p>The demo constructs a complete graph with random edge weights and exports it as GraphML. The
...
public final class GraphMLDemo {
  ...
  private static GraphImporter<CustomVertex, DefaultWeightedEdge> createImporter() {
    ...
    VertexProvider<CustomVertex> vertexProvider =
        new VertexProvider<CustomVertex>() {
          @Override
  ...
  public static void main(String[] args) {
    ...
    VertexFactory<CustomVertex> vFactory =
        new VertexFactory<CustomVertex>() {
          private int id = 0;
